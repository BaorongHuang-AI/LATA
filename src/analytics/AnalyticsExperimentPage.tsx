...
const METRICS_LIST = [
  ...
  { value: "delta_ttr", label: "Δ TTR (Target - Source)" },
  { value: "delta_guiraud_r", label: "Δ Guiraud's R (Target - Source)" },
  { value: "delta_avg_sentence_length", label: "Δ Avg Sentence Length" },
  { value: "delta_avg_word_length", label: "Δ Avg Word Length" },
  { value: "delta_passive_density", label: "Δ Passive Voice Density" },
  { value: "delta_pronoun_density", label: "Δ Pronoun Density" },
  { value: "delta_noun_ratio", label: "Δ Noun Ratio" },
  { value: "delta_preposition_density", label: "Δ Preposition Density" },
  { value: "delta_adverb_density", label: "Δ Adverb Density" },
  { value: "delta_conjunction_density", label: "Δ Conjunction Density" },
  { value: "delta_quote_density", label: "Δ Quote Density" },
  { value: "delta_bigram_ttr", label: "Δ Bigram TTR" },
  { value: "bigram_ttr", label: "Bigram TTR (Source)" },
  { value: "trigram_ttr", label: "Trigram TTR (Source)" },
  { value: "adverb_density", label: "Adverb Density (Source)" },
  { value: "conjunction_density", label: "Conjunction Density (Source)" },
  { value: "quote_density", label: "Quote Density (Source)" },
  { value: "question_density", label: "Question Density" },
  { value: "number_density", label: "Number Density (Source)" },
  { value: "transition_density", label: "Transition Phrase Density" },
  { value: "sentence_length_skewness", label: "Sentence Length Skewness" },
];
